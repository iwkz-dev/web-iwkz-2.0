export const translations = {
  id: {
    ...
    prs: {
      ...
      manualDonation: 'Cara donasi lainnya',
      paymentInfoButton: 'Info pembayaran',
      paymentInfoTitle: 'Informasi pembayaran manual',
      paymentInfoSubtitle:
        'Pilih metode, lalu salin informasi yang dibutuhkan.',
      paymentDescriptionLabel: 'Deskripsi',
      copy: 'Salin',
      copied: 'Tersalin',
  ...
  'de-DE': {
    ...
    prs: {
      ...
      manualDonation: 'Weitere Spendenmöglichkeiten',
      paymentInfoButton: 'Zahlungsinfo',
      paymentInfoTitle: 'Manuelle Zahlungsinformationen',
      paymentInfoSubtitle: 'Methode wählen und die benötigten Daten kopieren.',
      paymentDescriptionLabel: 'Beschreibung',
      copy: 'Kopieren',
      copied: 'Kopiert',
