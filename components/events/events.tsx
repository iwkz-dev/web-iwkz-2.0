...
const events = [
  {
    ...
    date: '2024-02-09',
    description:
      'Explore the richness of Indonesian culture through interactive sessions.',
  ...
  },
  {
    ...
    date: '2024-02-10',
    description:
      'Learn about Islamic finance principles and their applications in modern society.',
    image: '/images/hero-bg.webp',
  },
  {
    id: 3,
    ...
    date: '2024-02-11',
    description:
      'Bring a dish to share and connect with fellow community members!',
    image: '/images/hero-bg.webp',
  },
];
  ...
  return (
    <section className="relative min-h-dvh px-6 py-20 font-questrial flex m-auto flex-col items-center justify-center">
      <FadeInOnScroll>
        ...
        <div className="flex gap-4 overflow-x-auto snap-x snap-mandatory pb-4 md:grid md:grid-cols-3 md:gap-4 md:overflow-visible max-w-6xl mx-auto">
          {events.map((event) => {
