...
export default function ContactFooter({ contactFooterContent }: IContactFooterProps) {
    const {
        description,
        internal_links,
        social_media_links,
    ...
    const emailLine = parsedLines.find((line) => line.toLowerCase().includes('email'));
            ...
            <FadeInOnScroll>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 max-w-6xl w-full mx-auto text-center mb-6">
                    ...
                    <div className="space-y-2 flex flex-col items-center">
                        ...
                        <p className="text-sm text-gray-600">Untuk pertanyaan atau informasi:</p>
                        <Link
                            href={`mailto:${email}`}
